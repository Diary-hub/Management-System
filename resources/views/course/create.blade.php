...
<div class="w-full px-8 md:px-32 lg:px-24">
    <form method="post" action="{{ url('courses') }}" class="bg-white rounded-md shadow-2xl p-5">
        {!! csrf_field() !!}
        <h1 class="text-gray-800 font-bold text-2xl mb-1">Course Register</h1>
        ...
        <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl ">
            ...
            <input class="pl-2 w-full outline-none border-none" type="text" name="syllabus" id="syllabus" placeholder="Syllabus" />
        ...
        <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl ">
            ...
            <input class="pl-2 w-full outline-none border-none" type="text" name="duration" id="duration" placeholder="Duration" />
